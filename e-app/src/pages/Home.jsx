...
export default function Home() {
  ...
  return (
    ...
    >
      {/* Navbar */}
      <nav
        className={`navbar navbar-expand-lg ${theme === "dark" ? "navbar-dark bg-dark" : "navbar-light bg-light"} shadow-sm`}
      >
            ...
            <div className="d-flex align-items-center justify-content-center h-100">
              <div className="text-center p-5 text-white">
                ...
                <p className="lead mb-4">
                  Create, edit, and organize courses with ease. Instructors can
                  upload materials, set schedules, and track progress
                  seamlessly. Manage multiple courses, assign resources, and
                ...
                <br />
                <Link className="btn btn-light btn-lg mt-3" to="/signup">
                  Get Started
                </Link>
              </div>
            </div>
          ...
          <div className="carousel-item" style={{ height: "75vh" }}>
            ...
            >
              <div className="text-center p-5 text-white">
                ...
                <p className="lead mb-4">
                  Students can browse and enroll in courses, track their
                  learning path, and access resources anytime, anywhere. Get
                  personalized recommendations and certificates upon completion.
                </p>
          ...
          <div className="carousel-item" style={{ height: "75vh" }}>
            ...
            >
              <div className="text-center p-5 text-white">
                ...
                <p className="lead mb-4">
                  Stay updated with real-time notifications for new courses,
                  assignments, deadlines, and platform updates. Never miss
          ...
          <div className="carousel-item" style={{ height: "75vh" }}>
            ...
            >
              <div className="text-center p-5 text-white">
                ...
                <p className="lead mb-4">
                  Take interactive quizzes, get instant feedback, and track your
                  performance across courses with detailed analytics. Improve
          ...
          <div className="carousel-item" style={{ height: "75vh" }}>
            ...
            >
              <div className="text-center p-5 text-white">
                ...
                <p className="lead mb-4">
                  Rate courses and instructors, provide feedback to improve the
                  learning experience and help others choose the best courses.
          ...
          <div className="carousel-item" style={{ height: "75vh" }}>
            ...
            >
              <div className="text-center p-5 text-white">
                ...
                <p className="lead mb-4">
                  Report issues like malware content or platform problems.
                  Admins review and resolve complaints promptly for a safe and
      ...
      <section
        className={
          theme === "dark" ? "py-5 bg-dark text-white" : "py-5 bg-light"
        }
      >
            ...
            <div className="carousel-inner">
              <div className="carousel-item active" style={{ height: "60vh" }}>
                ...
                >
                  ...
                  <div className="col-md-6">
                    <h3 className="fw-bold text-primary animate__animated animate__fadeInRight">
                      Course Management
                    </h3>
                    <p className="lead animate__animated animate__fadeInRight animate__delay-1s">
                      Create, edit, and organize courses with ease. Instructors
                      can upload materials, set schedules, and track progress
                      seamlessly. Manage multiple courses, assign resources, and
                      monitor student engagement.
                    </p>
                    <ul className="list-unstyled">
                      <li>Intuitive course builder with drag-and-drop</li>
                      <li>
                        Multimedia content support (videos, PDFs, quizzes)
                      </li>
                      <li>Progress tracking and analytics</li>
                      <li>Collaborative tools for team teaching</li>
                    </ul>
              ...
              <div className="carousel-item">
                ...
                >
                  ...
                  <div className="col-md-6">
                    <h3 className="fw-bold text-success animate__animated animate__fadeInRight">
                      Enroll Courses
                    </h3>
                    <p className="lead animate__animated animate__fadeInRight animate__delay-1s">
                      Students can browse and enroll in courses, track their
                      learning path, and access resources anytime, anywhere. Get
                      personalized recommendations and certificates upon
                      completion.
                    </p>
                    <ul className="list-unstyled">
                      <li>Easy enrollment with one-click</li>
              ...
              <div className="carousel-item">
                ...
                >
                  ...
                  <div className="col-md-6">
                    <h3 className="fw-bold text-warning animate__animated animate__fadeInRight">
                      Notifications
                    </h3>
                    <p className="lead animate__animated animate__fadeInRight animate__delay-1s">
                      Stay updated with real-time notifications for new courses,
              ...
              <div className="carousel-item">
                ...
                >
                  ...
                  <div className="col-md-6">
                    <h3 className="fw-bold text-danger animate__animated animate__fadeInRight">
                      Quizzes & Assessments
                    </h3>
                    <p className="lead animate__animated animate__fadeInRight animate__delay-1s">
                      Take interactive quizzes, get instant feedback, and track
                      your performance across courses with detailed analytics.
                      Improve learning with adaptive questions.
                    </p>
                    <ul className="list-unstyled">
                      <li>Multiple question types (MCQ, essay, coding)</li>
                      <li>Instant results and explanations</li>
              ...
              <div className="carousel-item">
                ...
                >
                  ...
                  <div className="col-md-6">
                    <h3 className="fw-bold text-info animate__animated animate__fadeInRight">
                      Feedback & Ratings
                    </h3>
                    <p className="lead animate__animated animate__fadeInRight animate__delay-1s">
                      Rate courses and instructors, provide feedback to improve
                      the learning experience and help others choose the best
                      courses. Build a trusted community.
                    </p>
                    <ul className="list-unstyled">
                      <li>5-star rating system for courses</li>
                      <li>Detailed reviews and comments</li>
              ...
              <div className="carousel-item">
                ...
                >
                  ...
                  <div className="col-md-6">
                    <h3 className="fw-bold text-secondary animate__animated animate__fadeInRight">
                      Complaint Management
                    </h3>
                    <p className="lead animate__animated animate__fadeInRight animate__delay-1s">
                      Report issues like malware content or platform problems.
                      Admins review and resolve complaints promptly for a safe
